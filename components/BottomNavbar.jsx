...
const BottomNavbar = () => {
  return (
    <div className='h-[2vh] w-[90%] flex gap-6 justify-between items-center fixed bottom-0 p-8 bg-[#FFCF11] border-2 border-gray-300 rounded-[50px] mb-2 left-1/2 transform -translate-x-1/2'>
